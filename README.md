...
### CTO & Fullstack Developer @ SAARE TECH 🚀 | Building SaaS for African markets

[![Portfolio](https://img.shields.io/badge/Portfolio-000000?style=for-the-badge&logo=vercel&logoColor=white)](https://saaretech.com)
...
- 🏢 CTO & Fullstack Developer at **SAARE TECH**, building **SARO** (school management SaaS) and **BSCiT** (online training platform)
- 🎓 Currently completing a **Master 1 in Computer Science** at Université de Maroua
- 🌱 Currently exploring **Next.js, React Three Fiber, LSTM/ML** (rainfall prediction project)
- 📝 Sharing tech content via **La Minute Tech**
- 💬 Ask me about **Web & Mobile Development, SaaS architecture, Fintech in Cameroon**
